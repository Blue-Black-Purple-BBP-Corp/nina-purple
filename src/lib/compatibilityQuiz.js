...
export const ECRS_ITEMS = [
  ...
  { id: 'ecr7', subscale: 'avoidance', reverse: false,
    ...
    fr: "Je préfère ne pas montrer à un partenaire ce que je ressens au fond." },
  { id: 'ecr8', subscale: 'avoidance', reverse: false,
    en: 'I try to avoid getting too close to my partner.',
    fr: "J'essaie d'éviter de trop m'attacher à mon partenaire." },
  { id: 'ecr9', subscale: 'avoidance', reverse: false,
    en: 'I am nervous when partners get too close to me.',
    fr: "Je suis nerveux(se) quand un partenaire se rapproche trop." },
  { id: 'ecr10', subscale: 'avoidance', reverse: false,
    en: 'I find it difficult to allow myself to depend on romantic partners.',
    fr: "J'ai du mal à dépendre d'un partenaire amoureux." },
  { id: 'ecr11', subscale: 'avoidance', reverse: false,
    en: "I don't feel comfortable opening up to my partner.",
    fr: "Je ne me sens pas à l'aise de m'ouvrir à mon partenaire." },
  { id: 'ecr12', subscale: 'avoidance', reverse: false,
    en: 'I prefer not to depend on others or have others depend on me.',
...
export const BIG5_ITEMS = [
  ...
  { id: 'b5_a4', trait: 'agreeableness', reverse: false,
    ...
    fr: 'Je compatissante aux sentiments des autres.' },
  // Conscientiousness
  { id: 'b5_c1', trait: 'conscientiousness', reverse: false,
    en: 'Get chores done right away.',
    fr: 'Je fais mes tâches immédiatement.' },
  ...
  { id: 'b5_c4', trait: 'conscientiousness', reverse: true,
    en: 'Shirk my duties.',
    fr: "J'esquive mes responsabilités." },
  // Neuroticism
  { id: 'b5_n1', trait: 'neuroticism', reverse: false,
    en: 'Get stressed easily.',
