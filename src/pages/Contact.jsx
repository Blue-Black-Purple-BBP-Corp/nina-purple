...
export default function Contact() {
  ...
  return (
    <div className="min-h-screen px-6 py-20 max-w-2xl mx-auto">
      ...
      <p className="text-foreground/65 text-lg mb-12 leading-relaxed">
        {lang === 'fr'
      ...
      <div className="space-y-4">
        ...
        >
          ...
          <div>
            <div className="text-foreground/50 text-xs uppercase tracking-widest mb-0.5">
              {lang === 'fr' ? 'Courriel' : 'Email'}
            </div>
            <div className="text-foreground font-medium group-hover:text-[#F5A800] transition-colors">
        ...
        >
          ...
          <div>
            <div className="text-foreground/50 text-xs uppercase tracking-widest mb-0.5">Instagram</div>
            <div className="text-foreground font-medium group-hover:text-[#A855F7] transition-colors">
              @ninapurple.love
            </div>
          </div>
        </a>
