          ...
          {messagesLoading ? (
            ...
            <div className="text-center py-12 space-y-3">
              ...
              <p className="text-[#F0E6FF]/40 text-xs leading-relaxed max-w-xs mx-auto">
                {lang === 'fr'
                  ? `Votre premier message est inclus gratuitement avec le déverrouillage de la connexion. Soyez authentique — partagez ce qui vous a attiré dans cette connexion. Les réponses suivantes coûtent ${pricing.msg.toFixed(2)} $/message selon votre compatibilité.`
                  : `Your first message is included free with the connection unlock. Be genuine — share what drew you to this connection. Replies after that cost $${pricing.msg.toFixed(2)}/message based on your compatibility.`}
              </p>
            </div>
          ) : (
            messages.map(msg => {
